...
public class UltimateMobileQuickbarEditor : Editor
{
	...
	DisplaySceneGizmo DisplayDirectionalInputRadius = new DisplaySceneGizmo();
	...
	public override void OnInspectorGUI ()
	{
		...
		if( EditorPrefs.GetBool( "UMQ_QuickbarSettings" ) )
		{
			...
			valueChanged = false;
			EditorGUILayout.BeginVertical( "Box" );
			if( DisplayCollapsibleBoxSection( "Button Overlay", "UMQ_ButtonOverlay", useButtonOverlay, ref valueChanged ) )
			{
	...
	void OnSceneGUI ()
	{
		...
		DisplayDirectionalInputRadius.frames++;
