...
public class UltimateMobileQuickbarReadmeEditor : Editor
{
	...
	void MainPage ()
	{
		...
		EditorGUILayout.LabelField( "<b><color=red>PLEASE NOTE: </color></b> The new Input System from Unity does not support the Unity Remote application for testing. You will need to make a build in order to test touch functionality.", paragraphStyle );
		EditorGUILayout.Space();
		#endif
